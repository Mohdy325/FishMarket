package com.example.fishmarket.search_autocomplete;
        ...
        protected FilterResults performFiltering(CharSequence charSequence) {
            try {
                ...
                if (charSequence == null || charSequence.length() == 0) {
                    ...
                    Predictions predictions = googleMapAPI.getPlacesAutoComplete(charSequence.toString(),  "geocode", "en", "AIzaSyCFk43gjc8QQDUhs5xxPSHzoMQAro8dplI").execute().body();
